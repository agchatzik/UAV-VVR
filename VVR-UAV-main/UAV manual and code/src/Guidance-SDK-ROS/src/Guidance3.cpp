...
{
   myfile1.open ("/home/ubuntu/Desktop/imu_measurements/imu3.txt", std::ofstream::out | std::ofstream::app);
    myfile2.open ("/home/ubuntu/Desktop/imu_measurements/velocity3.txt", std::ofstream::out | std::ofstream::app);
    /// image counter raize
    image_counter ++;
    g_lock.enter();
    ...
    {        
		...
		if ( data->m_greyscale_image_left[CAMERA_ID] ){
            ...
            image_distance << "/home/ubuntu/Desktop/Drone_stereo_Images/images_left_3/Scene"<<image_counter<<".jpg";
		...
		if ( data->m_greyscale_image_right[CAMERA_ID] ){
            ...
            std::ostringstream image_distance;
            image_distance << "/home/ubuntu/Desktop/Drone_stereo_Images/images_right_3/Scene"<<image_counter<<".jpg";
            std::string copyOfStr = image_distance.str();
